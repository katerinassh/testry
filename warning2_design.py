...
"color: rgb(139, 140, 166);")
        ...
        self.pushButton.setGeometry(QtCore.QRect(150, 100, 151, 41))
        font = QtGui.QFont()
        font.setFamily(".AppleSystemUIFont")
        font.setPointSize(16)
        font.setBold(False)
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">There is not such test!</span></p></body></html>"))
