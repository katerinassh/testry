...
# Form implementation generated from reading ui file 'designsUi/edQstText_design.ui'
#
...
class Form_EdQstText(object):
    def setupUi(self, Form):
        Form.setObjectName("Editing Text answer question")
        Form.resize(614, 413)
...
"color: rgb(255, 255, 255);")
        ...
        self.label_4.setGeometry(QtCore.QRect(20, 150, 351, 41))
        self.label_4.setTextFormat(QtCore.Qt.RichText)
        self.label_4.setAlignment(QtCore.Qt.AlignCenter)
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(self.frame)
        self.label_5.setGeometry(QtCore.QRect(20, 270, 141, 41))
...
"font: 10pt \"MS Shell Dlg 2\"; ")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Editing Text answer question"))
        self.label_2.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:12pt;\">Enter the question</span></p></body></html>"))
        self.pushButton.setText(_translate("Form", "Confirm"))
        self.label_3.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:14pt;\">Editing the question with text answer</span></p></body></html>"))
        self.label_4.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">Enter the right answer (words that need to be included)</span></p></body></html>"))
